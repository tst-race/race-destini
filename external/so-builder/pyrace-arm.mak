...
# JCL
# x86: _py_incl="/android/x86_64/include/python3.7m -I/opt/android/ndk/21.3.6528147/sysroot/usr/include/ -I/opt/android/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/c++/v1/ios -I/opt/android/ndk/21.3.6528147/sources/cxx-stl/llvm-libc++/include -I/android/x86_64/include -I/opt/android/ndk/21.3.6528147/sysroot/usr/include/x86_64-linux-android/"

# ARM
_py_incl="/android/arm64-v8a/include/python3.7m -I."

# -nostdlib++

# ARM
_COPT="--sysroot=/opt/android/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/sysroot -g -DANDROID -fdata-sections -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security -Wall -Wconversion -Wshadow -Werror=conversion -Werror=sign-compare -O0 -fno-limit-debug-info -fPIE -std=c++17 -MD -MT"
# x86: _COPT="--target=x86_64-none-linux-android29 --gcc-toolchain=/opt/android/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64 --sysroot=/opt/android/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/sysroot -g -DANDROID -fdata-sections -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security -Wall -Wconversion -Wshadow -Werror=conversion -Werror=sign-compare -O0 -fno-limit-debug-info -fPIE -std=c++17 -MD -MT"

_LDOPT="-shared --sysroot=/opt/android/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/sysroot -g -DANDROID -fdata-sections -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security   -Wall -Wconversion -Wshadow -Werror=conversion -Werror=sign-compare -O0 -fno-limit-debug-info  -Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libgcc_real.a -Wl,--exclude-libs,libatomic.a -static-libstdc++ -Wl,--build-id -Wl,--fatal-warnings -Qunused-arguments -Wl,--gc-sections -L. -levent -ljsoncpp"
...
$CPP $_LDOPT -o IOManager_lib.so IOManager_wrap.o $_OBJ_LIST -L. libjsoncpp.so -L. CLICodec_lib.so -Wl,-rpath,\$ORIGIN
##/data/data/com.twosix.race/race/artifacts/comms/PluginCOMMSSRIPixelfed/libs

_make_CLICodec -L. libjsoncpp.so -L. IOManager_lib.so -Wl,-rpath,\$ORIGIN
#/data/data/com.twosix.race/race/artifacts/comms/PluginCOMMSSRIPixelfed/libs # make CLICodec_lib.so that references IOManager_lib.so
